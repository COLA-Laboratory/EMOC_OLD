...
//    {
//        UpdateArchiveByInd(Pop+i,Archive,epsilon);
//    }
    return;
}
...
//static void UpdateRHO(int row,int column,double **rho,int mixPopNum)
//{
//    int i = 0, j = 0;
//
//    for(i = row;i < mixPopNum-1;i++)
//    {
//        rho[i][column] = rho[i+1][column];
//
//    }
//
//
...
//}
//
//static void UpdateRank(int row,int column,double **rank,int mixPopNum)
//{
//    int i = 0, j = 0;
//
//    for(i = row;i < mixPopNum-1;i++)
//    {
//        rank[i][column] = rank[i+1][column];
//    }
//
//
//
...
//}
//
//static int IsInASet(int index,int *set,int num)
//{
//    int flag = 0;
//    int i = 0;
//
...
//    }
    ...
    while(mixedPopNum - count > g_algorithm_entity.algorithm_para.pop_size)
    {
        ...
        {
            //如果是上一輪我剔除的解
//            if(IsInASet(i,discardIndex,count))
//            {
//                for(j = 0;j < countArchive;j++)
...
//        endtime = clock();
//        runtime = (double)(endtime-begintime)/CLOCKS_PER_SEC;
//        printf("\n\n gengxin running Time：%fs\n", runtime);
        ...
        for(j = 0;j < countArchive;j++)
        {
            for(i = 0;i < mixedPopNum;i++)
            {
                if(rank[i][j] == worst)
                {
//                    UpdateRHO(i,j,rho,mixedPopNum);
//                    UpdateRank(i,j,rank,mixedPopNum);
...
//    printf("\n");
    ...
    for(i = 0;i < mixedPopNum;i++)
    {
//        if(IsInASet(i,discardIndex,count) == 0)
//        {
